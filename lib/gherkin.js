...
(function(window) {
  ...
  Gherkin2.prototype.feature = function feature(name, fn, thisArg) {

  }
  Gherkin2.prototype.scenario = function scenario(name, fn, thisArg) {

  }
  Gherkin2.prototype.step = function step(name, fn, thisArg) {
  ...
  function Gherkin() {
    ...
    function addDefinition(type, name, fn, thisArg) {
      ...
      if (type === CONST_STEP) {
        ...
        // TODO> Why this error is happening?!
        // console.error('undefined "' + type + '" to identify the "' + name + '". This should be a regexp or an string object');
      }
    }
